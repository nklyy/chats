...
var (
	...
	ErrAuthorizationToken             = errors.New(codes.Unauthorized, StatusAuthorizationToken)
	ErrRequiredAuthorizationToken     = errors.New(codes.Unauthorized, StatusRequiredAuthorizationToken)
	ErrFailedVerifyAuthorizationToken = errors.New(codes.Unauthorized, StatusFailedVerifyAuthorizationToken)
